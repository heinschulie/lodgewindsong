...
$(function () {
    $("#attractions").click(function () {
        $("#description").html(
            ...
            "<span>" + "Polokwane Game Reserve" + "</span>" + "<br> <br>" +
            ...
            "<span>" + "The Ranch Hotel" + "</span>" + "<br> <br>" +
            "The Ranch Hotel is a family leisure resort and wildlife conservancy that offers something to suit everyone. The Ranch Hotel is home to a pride of magnificent Lions. Take a walk on the wild side in the conservancy, meet the kings, watch their cubs at play, and walk with the Lions." + "<br>" + "<br>" +
            //"Contact details"+
            //"+27 (0)15 290 5000"+

            "<span>" + "Polokwane Bird and Reptile Park" + "</span>" + "<br> <br>" +
            "Over 280 bird species can be viewed both indigenous and exotic. Aquariums are a delight and home to snakes and lizards and dark pools showcase an array of crocodiles and water birds." + "<br>" + "<br>" +
            //"Contact details"+
            //"+27 (0)15 292 1719"+


            "<span>" + "Moletjie Bird Sanctuary" + "</span>" + "<br> <br>" +
            "Home too many bird species. Highly acclaimed internationally, the Centre is applauded for its outstanding work in the protection of the rare Cape Vulture." + "<br>" + "<br>" +
            //"Contact details:"+
            //"+27 (72) 693 4660"+

            "<span>" + "Mall of the North" + "</span>" + "<br> <br>" +
...
$(function () {
    $("#accommodation").click(function () {
        ...
        "<span class='spantitle'>" + "Accommodation and amenities:" + "</span>" + "<br>" + "<br>" +

        "Five stand-alone wooden cabin units, each equipped with functional bathrooms and basic amenities provides privacy and guarantees a peaceful night’s rest." + "<br> <br>" +
        "This self-catering destination is ideal for small company retreats or breakaway weekends. " + "<br> <br>" +

        "•	2 rooms with double beds" + "<br>" +
        "•	3 rooms with two single beds per unit." + "<br>" +
        "•	Extra mattresses are available for children." + "<br> <br>" +

        "A communal kitchen is fully equipped with cooking utensils, crockery and glassware, and includes stovetops, fridges and ample braai facilities nearby." + "<br> <br>" +
        "The common area (Lapa) provides comfortable seating and satellite television. Windsong Lodge also has a valid liquor licence." + "<br> <br>" +

        "A sheltered boma allows for safe bonfires, ideal for an evening under the starry skies of the bushveld." + "<br> <br>" +

        "Home-cooked meals are also available on request." + "<br> <br>" +

        "Safe on-site parking is available and the electrified fence surrounding the property is coupled to an alarm system and 24-hour armed response security team."
        + "<br> <br> <br>"
            );
    ...
    $("#title").click(function () {
        $("#description").html(
            "<br />" +
                        ...
                        "</span><br /><br /><span>" +
                        "Nestled in the heart of the Limpopo bushveld, yet less than 15 km from Polokwane (South Africa’s most Northern provincial capital), Windsong Lodge corresponds with the meaning of the nearby city’s Northern Sotho name, by providing the weary traveller or leisure seeking holidaymaker with a place of safety. " +
                        "</span>" +
                        "<br />" +
                        "<br />" +
            ...
            "Lift up your voice then and sing with the wind.' <br /> <br /> " +
